...
private:
	...
	/*
	Send your API key using the HTTP header X-FIGIMappingTool-APIKEY. With a valid API key, you will be subject to a higher rate-limit and request size.

	curl 'https://api.FIGIMappingTool.com/v3/mapping' \
	--request POST \
	--header 'Content-Type: application/json' \
	--header 'X-FIGIMappingTool-APIKEY: abcdefghijklmnopqrstuvwxyz' \
